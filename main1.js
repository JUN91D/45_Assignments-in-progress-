...
const favoriteNum = 7;
const Message = "Is My Favorite Number Because Of CR7 ";
...
const friends = ["gujjar", "hadi", "muneeb", "paras", "talha"];
for (let i = 0; i < friends.length; i++) {
    console.log(friends[i]);
}
//~done
//?12. Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
let myFriends = ["muneeb", "talha", "ali", "paras"];
for (let i = 0; i < myFriends.length; i++) {
    let friendName = myFriends[i];
    let someMsg = friendName + " is my friend";
    console.log(someMsg);
}
//~DONE
13; //? Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
let myCar = ["nissan", "hyndai", "honda", "corolla"];
let features = ["v10engine", "luxurious interior design", "unmatched speed"];
...
let guests = ["muneeb", "talha", "ali", "paras"];
let invitationMsg = "Your presence at my table would be greatly appreciated. Would you be able to join me for dinner?";
console.log(`${guests[0]} ${invitationMsg}\t\n \n${guests[1]} ${invitationMsg} \n \n${guests[2]} ${invitationMsg}\n\n${guests[3]} ${invitationMsg}`);
//~done
//?15. Changing Guest List: You just heard that one of your guests can’t make the dinner, so you need to send out a new set of invitations. You’ll have to think of someone else to invite.
//*• Start with your program from Exercise 14. Add a print statement at the end of your program stating the name of the guest who can’t make it.
console.log(`hey everyone, ${guests[2]} won't come to dinner because he had an accident`);
guests.pop();
//~DONE
...
let newMsg = "will you come at my house for dinner";
console.log(`${guests[2]} would also join us so ${newMsg}\n\n${guests[0]} ${newMsg}\n \n${guests[1]} ${newMsg} `);
guests.push(" hadi", " gujjar ", "usman");
console.log(`hey!!!! ${guests.slice(0, 3)} i've just found a bigger table so ${guests.slice(4, 7)} will also join us `);
...
let dreamPlaces = ["uk", "america", "russia", "germany", "italy"];
...
let Places = ["pechs", "shah re faisal"];
...
console.log(`i love these ${pizzas}  pizzas so so so much and i wanna talk about a lot but due to short time i am gonna stop here `);
...
let makeshirt = (size = "medium", inform = "this shirt is amazing") => `my shirt size is ${size} and i wanna say that ${inform}`;
{
    console.log(makeshirt());
}
// ? 37. Large Shirts: Modify the make_shirt() function so that shirts are large by default with a message that reads I love TypeScript. Make a large shirt and a medium shirt with the default message, and a shirt of any size with a different message.
const makeshirts = (size = "large", inform = "I Love Typescript") => `yours shirt's size is ${size} and your shirt print says ${inform}`;
...
let magician_names = ["jadugar", "junaid", "ali", "hamza"];
...
let magicians = ["paras", "ali", "junaid", "hamza"];
...
let newArr = ["ali", "ahmed", "saqib", "khalid"];
